...
namespace GameStore.UnitTests
{
    ...
    public class CartTests
    {
        ...
        public void Can_Add_New_Lines()
        {
            ...
            SoftWares soft1 = new SoftWares { ID_SoftWare = 1, Name = "Игра1" };
            SoftWares soft2 = new SoftWares { ID_SoftWare = 2, Name = "Игра2" };

            // Организация - создание корзины
            Cart cart = new Cart();

            // Действие
            cart.AddItem(soft1, 1);
            cart.AddItem(soft2, 1);
            List<CartLine> results = cart.Lines.ToList();

            // Утверждение
            Assert.AreEqual(results.Count(), 2);
            Assert.AreEqual(results[0].Soft, soft1);
            Assert.AreEqual(results[1].Soft, soft2);
        }
        ...
        public void Can_Add_Quantity_For_Existing_Lines()
        {
            ...
            cart.AddItem(soft1, 1);
            cart.AddItem(soft2, 1);
            cart.AddItem(soft1, 5);
            List<CartLine> results = cart.Lines.OrderBy(c => c.Soft.ID_SoftWare).ToList();
        ...
        public void Can_Remove_Line()
        {
            ...
            SoftWares soft1 = new SoftWares { ID_SoftWare = 1, Name = "Игра1" };
            SoftWares soft2 = new SoftWares { ID_SoftWare = 2, Name = "Игра2" };
            SoftWares soft3 = new SoftWares { ID_SoftWare = 3, Name = "Игра3" };
            ...
            cart.AddItem(soft1, 1);
            cart.AddItem(soft2, 4);
            cart.AddItem(soft3, 2);
            cart.AddItem(soft2, 1);

            // Действие
            cart.RemoveLine(soft2);

            // Утверждение
            Assert.AreEqual(cart.Lines.Where(c => c.Soft == soft2).Count(), 0);
        ...
        {
            // Организация - создание нескольких тестовых игр
            SoftWares soft1 = new SoftWares { ID_SoftWare = 1, Name = "Игра1", Price = 100 };
            SoftWares soft2 = new SoftWares { ID_SoftWare = 2, Name = "Игра2", Price = 55 };
       ...
       new SoftWares { ID_SoftWare = 1, Name = "Игра1", Category = new Categorys { ID_Category = 1 /* другие свойства */ }},
            ...
            Assert.AreEqual(cart.Lines.ToList()[0].Soft.ID_SoftWare, 1);
        }
